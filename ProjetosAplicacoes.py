...
VERSAO_ATUAL = "v1.0.10"  # Caixa de comentários em inserção de objetivos e de aplicações.
...
class AppInvest(ctk.CTk):
    ...
    def abrir_janela_objetivo(self, nome_preenchido=""):
        ...
        # --- NOVO CAMPO: COMENTÁRIOS DA JANELA DE OBJETIVOS ---
    ...
    def abrir_janela_aplicacao(self, nome_preenchido=""):
        # Aumentei a altura da janela de 550 para 620
        janela = self.criar_janela_secundaria("Gerenciar Aplicação", 750, 620)
        ...
        # --- NOVO CAMPO: COMENTÁRIOS DA JANELA DE APLICAÇÃO ---
        ...
        def adicionar_movimento():
            ...
            if nome not in self.dados["aplicacoes"]:
                self.dados["aplicacoes"][nome] = {
                    ...
                    "comentario": txt_comentario_app.get("1.0", "end-1c").strip(), # SALVA COMENTÁRIO
                    "movimentos": []
                }
            else:
                self.dados["aplicacoes"][nome]["tipo"] = combo_tipo_app.get()
                self.dados["aplicacoes"][nome]["comentario"] = txt_comentario_app.get("1.0", "end-1c").strip() # ATUALIZA COMENTÁRIO
...
if __name__ == "__main__":
    app = AppInvest()
>>>>>>> c0798969116f3e3ae25f00bc912150dc40c39ee1
    app.mainloop()